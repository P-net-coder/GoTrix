...
import com.event.gotrix.Adapter.FlightAdapter;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot issue : snapshot.getChildren()) {
                        ...
                        //To filter with data,uncomment below lines and comment top line/*
                     /* if (flight.getTo().equals(to) && flight.getDate().equals(date)) {8
                            list.add(flight);
                        }*/
                        if (!list.isEmpty()) {
